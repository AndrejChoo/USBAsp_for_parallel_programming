...
#define ledRedOn()    PORTB |= (1 << 0)
#define ledRedOff()   PORTB &= ~(1 << 0)
#define ledGreenOn()  PORTB |= (1 << 1)
#define ledGreenOff() PORTB &= ~(1 << 1)

#define SLOW_SCK_PORT PORTB
#define SLOW_SCK_PIN  PINB
#define SLOW_SCK_NUM  PB3
